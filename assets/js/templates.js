...
<script>
  ...
  roleAllow(id) {
    ...
    const map = {
      dashboard: all, about: all, contact: all, apply: all, 'feature-guide': all, notifications: all, academic_setup: admin, admin_data: admin, 'admin-data': admin, approvals: admin, storage: admin,
  ...
  iconFor(id) {
    const map = {
      dashboard:'🏠', about:'🏫', contact:'☎️', apply:'📝', 'feature-guide':'📘', 'cbt-exam':'🧪', 'academic-records':'📄', academic_setup:'⚙️', students:'👨‍🎓', staff:'👨‍🏫', classes:'📚', attendance:'📋', results:'📊',
  ...
  labelFor(id, fallbackName) {
    const map = {
      dashboard:'Dashboard', about:'About', contact:'Contact', apply:'Apply', 'feature-guide':'Feature Guide', 'cbt-exam':'Take Exam', 'student-profile':'Student Profile', 'academic-records':'Academic Records', academic_setup:'Academic Setup', students:'Students', staff:'Staff', classes:'Classes',
  ...
  allModules(config) {
    ...
    const dedicatedPages = ['student-profile','cbt-exam','academic-records','feature-guide','about','contact','apply','notifications'];
